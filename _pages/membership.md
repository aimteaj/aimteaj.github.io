...
- **Gireesh Nadh Mekala** – Road Traffic Prediction using Federated Learning
- **Srivatsa Tangirala** – Poisoning Attacks in Federated Learning using GANs
- **Madhu Nimeshika Dasika** – Skin Cancer Classification using Transfer Learning
- **Wasimuddin Fathimullah** – Intrusion Detection with Federated Reinforcement Learning

### 🎓 Undergraduate Research Students
- **Nadia D Lafontant** – Resource-Efficient Fine-Tuning of Vision-Language Models
- **Ian Tudor** – Drone Swarming, Distributed Streaming, and Learning
...
## 📰 Recognition and Community Projects

- Featured in **FIU CEC News** and **KFSCIS News**: **[Link](#)**
- Mentor of **FIU Thrive ML Team**, part of the **Green Family Foundation Neighborhood Health Education Learning Program (NeighborhoodHELP)**
- Collaborative AI-driven health research project funded by the **Florida Department of Health in Miami-Dade**
